...
$app_ads_enable = 1;    //$modSettings['tp_full_ads'];
$board_url = $boardurl;
if (file_exists($GLOBALS['boarddir'] . '/mobiquo/smartbanner/head.inc.php'))
    include($GLOBALS['boarddir'] . '/mobiquo/smartbanner/head.inc.php');
...
{
    global $boardurl, $user_info, $context, $exttMbqTempPageType, $modSettings, $board, $topic;
    ...
    else
    {
        if (!empty($board) && empty($topic))
        {
            ...
            $topics_per_page = $modSettings['defaultMaxTopics'];
        ...
        {
            $messages_per_page = $modSettings['defaultMaxMessages'];
