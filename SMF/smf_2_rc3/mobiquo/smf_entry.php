...
function smf_main()
{
    global $modSettings, $settings, $user_info, $board, $topic, $board_info, $maintenance, $sourcedir, $request_name, $txt, $user_settings, $mobiquo_config, $topic_per_page;
    ...
    $modSettings['defaultMaxMessages'] = 20;
    ...
    $local_action = array('login2', 'post', 'post2', 'who', 'profile', 'notify', 'markasread', 'unread', 'search2', 'pm');
