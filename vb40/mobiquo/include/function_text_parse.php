                ...
                switch($attachment['extension'])
                {
                    ...
                    case 'pdf':
                        ...
                        if (($settings OR ($vbulletin->options['attachthumbs'] AND $attachment['hasthumbnail'])) AND $vbulletin->userinfo['showimages'])
                        {
                            ...
                            $hrefbits = array(
                                    'href'   => "{$vbulletin->options['bburl']}/attachment.php?{$vbulletin->session->vars['sessionurl_js']}attachmentid=\\1&d=$attachment[dateline]",
                                    'id'     => 'attachment\\1',
                            );
                            if ($lightbox)
                            {
                            ...
                            $imgbits = array(
                                    'src'    => "{$vbulletin->options['bburl']}/attachment.php?{$vbulletin->session->vars['sessionurl_js']}attachmentid=\\1&d=$attachment[thumbnail_dateline]",
                                    'border' => '0',
