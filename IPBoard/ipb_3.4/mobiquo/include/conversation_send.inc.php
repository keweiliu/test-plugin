...
class tapatalk_conversation_send extends ipsCommand
{
    public $result;
    ...
    public function doExecute( ipsRegistry $registry )
    {
        ...
        switch( $this->request['do'] )
        {
            ...
            break;
            case 'replyForm':
                $this->result = $this->_showForm2( 'reply' );
                
            break;
            case 'send':
                $this->result = $this->_sendNewPersonalTopic();
            break;
            case 'sendReply':
                $this->result = $this->_sendReply();
            break;
            case 'editMessage':
	...
	protected function _showForm2( $type, $errors='' )
	{
		...
		$displayData['uploadData']['attach_stats']	= $class_attach->attach_stats;
 		...
 		$displayData['message'] = str_replace('&nbsp;', ' ', IPSText::UNhtmlspecialchars(IPSText::UNhtmlspecialchars($match[2])));
