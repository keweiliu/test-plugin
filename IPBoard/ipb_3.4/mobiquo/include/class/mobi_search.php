...
class mobi_search extends ipsCommand
{
	...
	public function doExecute( ipsRegistry $registry )
	{
		...
		global $request_params,$request_name;
		if ($request_name == 'get_unread_topic' || $request_name == 'get_latest_topic')
		    IPSSearchRegistry::set('opt.search_per_page', (int) ($request_params[1]-$request_params[0]+1));
		elseif ($request_name == 'get_participated_topic')
		    IPSSearchRegistry::set('opt.search_per_page', (int) ($request_params[2]-$request_params[1]+1));
		else
		    IPSSearchRegistry::set('opt.search_per_page', isset( $search_filter['perpage'] ) ? intval( $search_filter['perpage'] ) : 20 );
	...
	public function viewUserContent()
	{
		...
		else if ($this->request['user_name'])
		{
